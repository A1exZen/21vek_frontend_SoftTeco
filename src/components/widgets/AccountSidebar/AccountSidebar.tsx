...
import { Heart, List, LogOut, ShoppingCart, User } from 'lucide-react';
  ...
  return (
    <div className={styles['account-dropdown']}>
      ...
      <div className={styles['account-dropdown__content']}>
        ...
        <Link to={PATHS.FAVORITES} className={styles['account-dropdown__link']}>
          <div className={styles['account-dropdown__item']}>
            <Heart size={20} />
            <span className={styles['account-dropdown__text']}>Избранное</span>
          </div>
        </Link>
